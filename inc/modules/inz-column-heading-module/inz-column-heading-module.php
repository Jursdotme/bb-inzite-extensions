...
/**
 * @class InziteHeadingModuleClass
 */
class InziteHeadingModuleClass extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(array(
			'name'          	=> __( 'Column Heading', 'fl-builder' ),
 ...
 */
FLBuilder::register_module('InziteHeadingModuleClass', array(
	'general'       => array(
			...
			'colors'        => array(
				...
				'fields'        => array(
					...
					'background_color' => array(
						'type'          => 'color',
						'label'         => __( 'Background color', 'bb-inz-e' ),
						'show_reset'    => true,
